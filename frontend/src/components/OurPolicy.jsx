...
const OurPolicy = () => {
  return (
    <div className='flex flex-col bg-slate-100 sm:flex-row justify-around gap-10 sm:gap-2 text-center pt-32 pb-20 text-xs sm:text-sm md:text-base text-gray-700'>
